                                    ...
                                    return (
                                        <li key={i}>
                                            ...
                                            {cluster.validator_count > 0 && (
                                                <ClusterRemoveValidator poolAddress={cluster.owner_address} operatorIDs={cluster.operators} />
                                            )}
                                        </li>)
                                })}
                            </div>
...
const ClusterRemoveValidator = ({ poolAddress, operatorIDs }: { poolAddress: Address, operatorIDs: number[] }) => {
    ...
    return (
        <>
            <SSVRemoveValidator validatorPubKey={poolPubKey} clusterData={clusterData} />
        </>
    )
