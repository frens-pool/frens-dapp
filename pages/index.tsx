...
const Operator: NextPage = () => {
  ...
  const number = (step: STEP_TYPE) => ["1️⃣", "2️⃣", "3️⃣", "4️⃣", "5️⃣"][STEPS.indexOf(step)];
  ...
  const className = (current_step: STEP_TYPE, step: STEP_TYPE) => `${current_step == step ? "block" : "hidden"}`;
  ...
  return (
    ...
    >
      ...
      <main className="flex flex-col justify-center items-center min-h-[93vh]">
        ...
        <div className="z-20 w-11/12 md:w-2/3 text-center flex flex-col items-center border-2 border-slate-400 rounded-md mb-4 p-3 bg-white">
          <h1 className="text-3xl font-bold">{number("Upload")} Upload deposit file</h1>
        ...
        <div className="z-20 w-11/12 md:w-2/3 text-center flex flex-col items-center border-2 border-slate-400 rounded-md mb-4 p-3 bg-white">
          <h1 className="text-3xl font-bold">{number("Invite")} Invite Friends</h1>
          <div className={`${step == "Invite" || step == "Run" ? "block" : "hidden"}`}>
            <InviteFrens
