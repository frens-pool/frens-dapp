  ...
  return (
    <div className="w-full flex-col items-center justify-center border-b-[1px] border-frens-blue border-dashed">
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-end justify-start">
        ...
        <div className="text-[14px] mb-4 lg:mb-[8px] lg:ml-3 font-semibold lg:font-normal">Owned by {accountPoolOwner?"you (":null}<a className="underline" href="/">{operatorENS?ensName:`${operatorAddress.slice(0,4)}...${operatorAddress.slice(-4)}`}</a>{accountPoolOwner?")":null}</div>
      </div>
