    ...
    >
      ...
      <div className="w-full grid grid-cols-3 gap-x-8 gap-y-2 lg:flex lg:flex-row lg:items-center lg:justify-start">
          <div className="flex flex-1 flex-col items-start justify-end">
            <div className="text-[10px] uppercase text-frens-blue mb-[4px]">Pool</div>
          ...
          {pool.creator && (
            <div className="hidden lg:flex flex-col items-start justify-end lg:ml-10">
              <div className="text-[10px] uppercase text-frens-blue mb-[4px]">Pool owner</div>
          ...
          {showClusterInfo && (
            <div className="flex flex-col items-start justify-end lg:ml-10">
              <div className="text-[10px] uppercase text-frens-blue mb-[4px]">Cluster Balance</div>
              <div className="font-semibold">
          ...
          {showClusterInfo && (
            <div className="flex flex-col items-start justify-end lg:ml-10">
              <div className="text-[10px] uppercase text-frens-blue mb-[4px]">Cluster Runway</div>
          ...
          {!showClusterInfo && (
            <div className="flex flex-col items-start justify-end lg:ml-10">
              <div className="text-[10px] uppercase text-frens-blue mb-[4px]">Pool Stakes</div>
              <div className="font-regular lg:font-semibold">{pool.deposits.length}</div>
            </div>
          )}

          {!showClusterInfo && (
            <div className="flex flex-col items-start justify-end lg:ml-10">
              <div className="text-[10px] uppercase text-frens-blue mb-[4px]">Collected</div>
              <div className="font-regular lg:font-semibold">
                {formatEther(
                  BigInt(
           ...
           {/* :::::: THIS NEEDS CONDITION OF POOLSTATE :::::: */}
            <div className="hidden lg:flex flex-col items-start justify-end lg:ml-10">
              <div className="text-[10px] uppercase text-frens-blue mb-[4px]">Pool Status</div>
