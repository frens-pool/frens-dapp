  ...
  <footer className="bg-black pt-16 lg:pt-20 pb-24 lg:pb-24 flex flex-col lg:flex-row items-start lg:items-center justify-start">
    ...
    <div className="flex flex-col items-start lg:items-end justify-start pr-[8vw] px-[12vw] lg:pr-[4vw]">
      <img
        ...
        alt="Staking with Frens"
      />
      <h2 className="font-extrabold text-[20px] my-2 teal-to-blue inline-block text-transparent bg-clip-text">
        Staking ETH together
      </h2>
      <Link
        href="/"
        className="text-white mt-2 text-[14px] font-semibold hover:text-frens-blue"
      >
        All pools
      </Link>
      <Link
        href="/dashboard"
        className="text-white text-[14px] font-semibold hover:text-frens-blue"
      >
        My Dashboard
      </Link>
      <Link
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="text-[12px] text-slate-500 mt-6"
      >
        Made with ❤️ by your{" "}
        <span className=" text-frens-main undeline">FRENS</span> 🤙
      </a>
      <div className="text-[12px] text-slate-500">
        Version: v1.0.0 - Commit Hash: 6b012eb
      </div>
    </div>
  </footer>
);
